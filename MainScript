...
LocalPlayer.CharacterAdded:Connect(function(char)
	repeat task.wait(0.1) until char ~= nil
...
local Key = "AetherClient | .gg/HdqjAfBq" --DONT CHANGE OR SCRIPT WILL BREAK
...
DragonAnimation = Killaura.NewToggle({
 Name = "DragonAnimation", 
Function = function() end
})
...
local msgs = {"gg.HdqjAfBq Get AetherClient Now!","Even without AetherClient i wouldve still won.","AetherClient On Top⭐","Imagine being legit in 2024","Get AetherClient to win lol!"}
...
if toxic == true then
    local msgs = {"Dying in a BLOCK game is sad","Why bother when AetherClient Private exists","LOL HOW DO YOU LOSE IN A BED GAME","AetherClient PRIVATE IS JUST BETTER","IVE NEVER LOST WITH AetherClient PRIVATE LOL"}
		newChat(msgs[math.random(1,5)])
    end
end)
